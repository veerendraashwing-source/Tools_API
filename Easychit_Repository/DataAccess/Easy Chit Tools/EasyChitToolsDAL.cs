...
//        {
//                if (dto == null || string.IsNullOrEmpty((string)dto.Contact_Id))
...
//                    string query = $@"
//                        UPDATE {globalSchema}.tbl_mst_contact SET contact_name = @NewName,contact_surname = @NewSurname,
//                            contact_mailing_name = @NewMailingName WHERE tbl_mst_contact_id = @ContactId";
...
//            {
//                // Log error if needed
//                throw new Exception("Error in SaveNameChange: " + ex.Message, ex);
//            }
//        }
...
//        public bool SaveNameChange(string globalSchema, string conn, Easychit_Infrastructure.Easy_Chit_Tools.NameChangeDto1 dto)
//        {
